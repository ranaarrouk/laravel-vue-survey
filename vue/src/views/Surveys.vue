<template>
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
      <div class="flex flex-col px-6 py-4 shadow-md bg-white hover:bg-grey-50 h-[470px]"
        ...
        <div class="flex justify-between items-center mt-4">
          <router-link
            ...
            class="flex border border-transparent py-2 px-4 text-sm text-white rounded-md bg-indigo-600 hover:bg-indigo-700
...
focus:ring-2 focus:ring-offset-2 focus:red">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
